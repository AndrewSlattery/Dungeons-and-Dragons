...
**Pulpy low fantasy set inside a classic high-fantasy world.** The great kingdoms, archmages, and dragon flights exist — they're distant rumour and traveller's tale. The party lives in the margins: trade roads, port towns, tavern back rooms, the unglamorous machinery of a world that doesn't stop for heroes.

Stakes are personal and immediate. Rent. Reputation. Survival. The cargo that went wrong. The friend who hasn't written back. Not "save the world" — at least not yet, and not obviously.

Morally grey NPCs. Practical problems. The occasional brush with something genuinely arcane, and the sense that the world is larger and stranger than the Fenway road suggests.

---

## DM Principles

1. **Roll only when it matters.** Call for a roll only when both success and failure are plausible and interesting. Auto-succeed the trivial. Auto-fail the impossible. Narrate everything else.
2. **DC before dice.** Set the Difficulty Class before invoking the roll. Keep rulings honest.
...
| Character | Species | Class | Role | Alignment |
|---|---|---|---|---|
...
## Character Hooks & Threads

### Cade

- **Sael's disappearance.** His navigator friend from the *Grey Cormorant* crew is missing from Kelstead Port. A message left at the port chapel was collected but never answered. Cade checks for replies at every town with a chapel or postal function. Nothing yet. He is giving it time, because Sael was resourceful. He is trying not to calculate how much time is too much.
- **The Storm divine.** His Storm Giant Ancestry is not purely cosmetic. Something in his bloodline is connected to something listening. What that connection is, what it wants, and how it will express itself at higher levels is a thread to develop slowly. Don't name it too early.
- **Childhood friends.** Akander (first mate, southern coastal runs, fine), Corvan (dock factor at Kelstead, nervous, useful), Sael (missing). These are not resources for the party — they are Cade's people, separate from his present circumstances. The tension between those two worlds is his.
- **The Orrath connection.** The Goliath blacksmith who taught Rixon Giant came from Greymantle Keep, the highland community above Stoneveil Reach where Cade grew up. Cade registered this during the voyage. He has not yet asked more than the surface question. The depth of this thread runs through Rixon's history into something larger.

### Rixon

- **Orrath and the sealed forge.** Why was the Ashford Guild closure sealed? What was Orrath producing that required sealed records rather than public charges? Rixon has pieces of this knowledge embedded in his training — muscle memory, arcane theory, things Orrath explained in the language of the forge — and does not fully understand what he knows. This thread connects outward toward his Eldritch Knight path and inward toward whatever Orrath was actually doing.
- **The discharge.** Technically honourable. Specific circumstances: unstated and intentionally blank. Develop when it surfaces naturally. It should surface through an NPC who recognises him, or through a document, not through Rixon volunteering it.
...
- **Vex (Rixon, Handaxe / Mall-Lowick, Shortsword):** On hit, the attacker gains Advantage on their next attack roll against that target. Coordinate target selection.
- **Slow (Mall-Lowick, Longbow):** On hit, target's speed reduced by 10 ft until the start of Mall-Lowick's next turn.
...
| Hunter's Mark (free) | Mall-Lowick | 2 | Long Rest |
...
|---|---|---|---|
| Vetha | Thornwater (detained) | Captain, *The Grey Cormorant* | Detained by local authority |
| Corvan | Kelstead Port | Dock factor; Cade's childhood friend | At his desk, nervous |
| Akander | At sea (southern routes) | First mate, trading ketch | Fine; occasional correspondence |
| Sael | Unknown | Navigator; Cade's childhood friend | **Missing** |
| Alderman Cray | Brindlemark | Town administrator | To be met |
