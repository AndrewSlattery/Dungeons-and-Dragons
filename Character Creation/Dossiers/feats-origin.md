# D&D 2024 — Origin Feats

> All information sourced from the Player's Handbook (2024) via dnd2024.wikidot.com.

Origin feats are granted by your background at character creation (Level 1). They represent early training or natural talent before your adventuring career began.
...
- **Tool Proficiency.** You gain proficiency with **three different Artisan's Tools** of your choice from the Fast Crafting table below.
- **Discount.** Whenever you buy a nonmagical item, you receive a **20 percent discount** on it.
- **Fast Crafting.** When you finish a **Long Rest**, you can craft one piece of gear from the Fast Crafting table below, provided you have the associated Artisan's Tools and proficiency with them. The item lasts until you finish another Long Rest, at which point it falls apart.
...
> When granted by a background, the spell list is pre-specified:
> - **Acolyte** → Cleric list
> - **Guide** → Druid list
> - **Sage** → Wizard list

*Granted by: Acolyte, Guide, Sage*
...
*Granted by: Charlatan, Noble, Scribe*
